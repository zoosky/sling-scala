...
public class Sling475Test extends HttpTestBase {
	...
	resourceTypeXQ = resourceTypeX + "/q";
        props.clear();
        props.put("sling:resourceType", resourceTypeXQ);
      contentUrlQ = testClient.createNode(HTTP_BASE_URL +resourceTypeXQ, props);
      ...
      uploadTestScript(resourceTypeXQ,"suffixtest.jsp","suffixtest.jsp");
    }
    ...
    public void testReplaceSuffix() throws Exception {
        ...
        final String content = getContent(contentUrlQ + ".html/a.html" , CONTENT_TYPE_HTML);
        assertTrue("The test from the replacement script",content.contains("The suffix in suffixtest.jsp is"));
        assertTrue("The suffix from the replacement script",content.contains("a.b"));
    }
